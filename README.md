...
- **Global Text Protection Mask** [optional] - The string value used for the global text protection mask value. When masking a protected string, it will be replaced by this value.
